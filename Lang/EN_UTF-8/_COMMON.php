...
$_LANG['SyncUser']          = 'Sync User';
$_LANG['SyncUserNew']          = 'Sync New User';
$_LANG['SyncUserOld']          = 'Sync Update User';
...
$_LANG['SyncGroupNew']         = 'Sync Add Group';
$_LANG['SyncGroupOld']         = 'Sync Update  Group';
...
(
    ...
    "BugsPerOS"          => 'pie',
    "BugsPerBrowser"     => 'pie',
    "OpenedBugsPerUser"  => 'bar',
    "OpenedBugsPerDay"   => 'polarArea',
    "OpenedBugsPerWeek"  => 'polarArea',
    "OpenedBugsPerMonth" => 'polarArea',
    "ResolvedBugsPerDay" => 'Line',
    "ResolvedBugsPerWeek"  => 'Line',
    "ResolvedBugsPerMonth" => 'Line',
    "ClosedBugsPerUser"   => 'bar',
    "ClosedBugsPerDay"    => 'polarArea',
    "ClosedBugsPerWeek"   => 'polarArea',
    "ClosedBugsPerMonth"  => 'polarArea',
    "ActivatedBugsPerDay" => 'polarArea',
    "ActivatedBugsPerWeek" => 'polarArea',
    "ActivatedBugsPerMonth" => 'polarArea',
    "AssignedBugsPerUser" => 'bar',
    "ResolvedBugsPerUser" => 'bar',
    "BugsPerResolution"  => 'bar',
    "BugsPerType"        => 'bar',
    "BugLiveDays"        => 'polarArea',
    "BugHistorys"        => 'polarArea',
    "CasesPerProject"    => 'pie',
    "CasesPerModule"     => 'pie',
    "CasesPerStatus"     => "pie",
    "CasesPerPriority"   => "pie",
    "CasesPerType"       => "pie",
    "CasesPerMethod"     => "pie",
    "CasesPerPlan"       => "pie",
    "OpenedCasesPerUser" => "bar",
    "OpenedCasesPerDay"  => "polarArea",
    "OpenedCasesPerWeek" => "polarArea",
    "OpenedCasesPerMonth" => "polarArea",
    "CasePerScriptStatus" => "bar",
    "CasesPerScriptedBy"  => "bar",
    "ScriptedDatePerDay"  => "polarArea",
    "ScriptedDatePerWeek" => "polarArea",
    "ScriptedDatePerMonth" => "polarArea",
    "ResultsPerProject"    => "pie",
    "ResultsPerModule"     => "pie",
    "ResultsPerValue"      => "pie",
    "ResultsPerStatus"     => "pie",
    "OpenedResultsPerUser"  => "bar",
    "OpenedResultsPerDay"   => "polarArea",
    "OpenedResultsPerWeek"  => "polarArea",
    "OpenedResultsPerMonth" => "polarArea",
    "ResultsPerOS"          => "polarArea",
    "ResultsPerBrowser"     => "polarArea",
);
...
$_CFG['ReportGraphOption']['polarArea'] = $_CFG['ReportGraphOption']['Default'] + array();
$_CFG['ReportGraphOption']['polarArea'] = $_CFG['ReportGraphOption']['Default'] + array();
$_CFG['ReportGraphOption']['bar']    = $_CFG['ReportGraphOption']['Default'] + array();
$_CFG['ReportGraphOption']['pie']    = $_CFG['ReportGraphOption']['Default'] + array
(
